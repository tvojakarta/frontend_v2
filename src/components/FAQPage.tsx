...
export function FAQPage({ onNavigate }: FAQPageProps) {
  ...
  const faqData = [
    ...
    },
    {
      id: 'accessibility',
      question: {
        sr: 'Da li su lokacije pristupačne osobama sa invaliditetom?',
        en: 'Are venues accessible for people with disabilities?'
      },
      answer: {
        sr: 'Većina naših lokacija je pristupačna osobama sa invaliditetom. Za specifične informacije o pristupačnosti, molimo kontaktirajte nas prije rezervacije karte.',
    ...
    },
    {
      ...
      answer: {
        sr: 'Da, nudimo grupne popuste za grupe od 10 ili više ljudi. Kontaktirajte našu prodaju putem emaila ili telefona za individualna rješenja i posebne cijene.',
